...
const NavBar = () => {
  ...
  return (
    <div className="w-full flex bg-[#000]">
      <div className="md:flex-col w-full max-w-7xl items-center justify-center h-15 md:h-35 text-white py-2 md:py-4 mx-auto mb-12 sm:mb-0">
        <Link to={'/'}>
